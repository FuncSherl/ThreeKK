...
class base(Cards.base.base):
    ...
    name='base_horse_minus'
    name_pinyin='base_horse_minus'
    describe='base_horse_minus'
    
    type=Config.Card_type_enum[4] #默认是基本牌['basic', 'skill', 'armer', 'shield', 'horse_minus', 'horse_plus']
    against_names=[]
    damage=0
    active=True
    scop=1  #手长 
...
#############################################################
    ...
    def on_hit_player(cls,  person_start, person_end, card):
        person_end.add_horse_minus(card)
        return True
